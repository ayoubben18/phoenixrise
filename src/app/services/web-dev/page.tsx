...
import {TbBrandNextjs, TbSquareRoundedNumber3Filled, TbSquareRoundedNumber4Filled} from "react-icons/tb";
...
export default function page() {
    return (
        <div className='section-style text-center px-4'>
            ...
            <p className='text-slate-200 text-lg opacity-70'>Our web development service is very flexible and modern
                using the latest frameworks and technologies</p>
            <ul className="timeline timeline-snap-icon space-y-5 max-md:timeline-compact timeline-vertical">
                <li>
                    ...
                    <div className="timeline-start mt-2 px-4 md:text-end mb-10">
                        ...
                        <div className="text-2xl xs:text-3xl text-left sm:text-right font-black">Front-end Stack</div>
                ...
                <li>
                    ...
                    <div className="timeline-end mt-2 px-4 mb-10">
                        <div className="text-2xl xs:text-3xl text-left font-black">Back-end Stack</div>
                ...
                <li>
                    ...
                    <div className="timeline-start mt-2 px-4 md:text-end mb-10">
                        <div className="text-2xl xs:text-3xl text-left sm:text-center font-black">Databases</div>
                        <div className="flex gap-3 mt-3 items-center justify-center">
                            <SiTurso size={50}/>
                ...
                <li>
                    ...
                    <div className="timeline-end px-4 mt-2 mb-10 max-w-[400px] text-left">
                       ...
                       Our team is very flexible in using various tools and frameworks to adapt with the customer needs,So this stack is basic we are flexible in introducing new technologies to it.
