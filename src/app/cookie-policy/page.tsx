    ...
    <TracingBeam className="px-2">
      <div className="py-36 flex flex-col gap-3 container">
        ...
        <p>
          ...
          providing personalized content and ads, and to improve the
          functionality of our website. We do not use cookies to collect
        ...
        <p>
          ...
          note that if you choose to block cookies, you may not be able to use
        ...
        <p>
          ...
          changes we may make to our Cookie Policy in the future will be posted
