    ...
    return (
        <div className="py-36 flex flex-col gap-3 container px-10 sm:px-36">
            ...
            <p>This Privacy Policy describes how [Agency Name] ("we" or "us") collects, uses, stores, and discloses
                information obtained from users of our website and services. By accessing our website and utilizing our
                services, you agree to the collection and use of information in accordance with this Privacy Policy.</p>
            <h2 className="text-xl font-semibold mt-4">1. Information Collection and Use</h2>
            <p>We may collect personal information such as name, email address, contact information, and payment details
                when you engage with our services. This information is used to provide and improve our services and to
            ...
            <p>You have the right to access, correct, amend, or delete any personal information we hold about you. You
                also have the right to withdraw consent for the processing of your personal data. To exercise these
                rights, please contact us using the information provided in the "Contact Information" section below.</p>
            <h2 className="text-xl font-semibold mt-4">5. Cookie Usage</h2>
            <p>Our website may use "cookies" to enhance user experience. Users may choose to set their web browser to
                refuse cookies or to alert them when cookies are being sent. If they do so, note that some parts of the
                site may not function properly.</p>
            <h2 className="text-xl font-semibold mt-4">6. Legal Requirements</h2>
            <p>We will disclose your personal information where required to do so by law or subpoena or if we believe
                that such action is necessary to comply with the law and the reasonable requests of law enforcement or
            ...
            <p>We reserve the right to update this Privacy Policy at any time. We encourage users to frequently check
