  ...
  return (
    <TracingBeam className="px-2">
      <div className="py-36 flex flex-col gap-3 container ">
        ...
        <p>
          This Privacy Policy describes how [Agency Name] ("we" or "us")
          collects, uses, stores, and discloses information obtained from users
          of our website and services. By accessing our website and utilizing
        ...
        <p>
          ...
          contact information, and payment details when you engage with our
          services. This information is used to provide and improve our services
          and to communicate with you. We may also collect non-personal
          information such as browser type, operating system, and IP address for
          analytical purposes.
        </p>
        <h2 className="text-xl font-semibold mt-4">
        ...
        <p>
          ...
          information. We implement appropriate data collection, storage, and
        ...
        <p>
          ...
          rights, please contact us using the information provided in the
        ...
        <p>
          ...
          to protect the security or integrity of our site.
        </p>
        <h2 className="text-xl font-semibold mt-4">
