    ...
    <TracingBeam className="px-2">
      <div className="py-36 flex flex-col gap-3 container">
        ...
        <p>
          ...
          services offered by our agency. By accessing and using our website,
          you agree to comply with and be bound by these terms and conditions.
          If you disagree with any part of these terms and conditions, you must
          not use our website.
        </p>
        ...
        <p>
          ...
          accurate and timely information required for the successful execution
          of the agreed services. The client must also comply with all legal and
        ...
        <p>
          The term for the services shall commence on the start date indicated
          in the agreement and shall continue for the term of the contracted
          services. Either party may terminate the agreement by providing
          written notice as per the terms outlined in the agreement.
        </p>
        ...
        <p>
          ...
          but not limited to the design, content, and any proprietary
          technology, shall remain the property of the agency unless otherwise
        ...
        <p>
          ...
          data, use, goodwill, or other intangible losses, resulting from the
          use of our services.
        </p>
        ...
        <p>
          For any queries or concerns regarding the terms of use or our
        ...
        <div className="flex flex-col text-sm xs:text-lg  sm:text-xl font-medium pt-7">
          ...
          <p>Phone: +212613506807</p>
          <div className="flex flex-wrap">
            Email:
            <a
              href="mailto:phoenixriseteam@gmail.com"
              className="text-blue-600 visited:text-purple-600"
            >
