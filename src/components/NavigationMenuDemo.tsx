...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "top-10 inset-x-0 max-w-2xl mx-auto px-1 xs:px-10",
        className
      )}
    >
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Contact">
          <div className="flex flex-col space-y-4 text-sm">
            <HoveredLink href="mailto:phoenixriseteam@gmail.com">
              Email
            </HoveredLink>
            <HoveredLink href="https://www.linkedin.com/company/phoenixriseteam/">
              Linkedin
            </HoveredLink>
